...
public class UserBootstrapper implements CommandLineRunner {
    ...
    private void createReaders() {
        ...
        if (userRepository.findByUsername("manuel@gmail.com").isEmpty()) {
            ...
            Optional<GenreSync> g1 = genreSyncRepository.findByGenre("Fantasia");
            Optional<GenreSync> g2 = genreSyncRepository.findByGenre("Infantil");
            List<GenreSync> interestList = new ArrayList<>();
            if(g1.isPresent()) {
