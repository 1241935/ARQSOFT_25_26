...
public class Lending {
    ...
    /**
     * {@code BookSync} associated with this {@code Lending}.
     * This is a synchronized copy from the Books microservice.
     * */
    @NotNull
    @Getter
    @ManyToOne(fetch=FetchType.EAGER, optional = false)
    private BookSync book;
     ...
     *
     * @param       book {@code BookSync} object, synchronized from the Books microservice.
     ...
     * */
    public Lending(BookSync book, ReaderDetails readerDetails, int seq, int lendingDuration, int fineValuePerDayInCents){
        try {
    ...
    public static Lending newBootstrappingLending(BookSync book,
