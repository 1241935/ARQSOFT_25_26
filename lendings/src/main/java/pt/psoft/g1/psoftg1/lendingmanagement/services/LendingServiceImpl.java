...
public class LendingServiceImpl implements LendingService{
    ...
    private LendingEventsPublisher lendingEventsPublisher;
    ...
    public Lending create(final CreateLendingRequest resource) {
        ...
        final var b = bookSyncRepository.findByIsbn(resource.getIsbn())
                .orElseThrow(() -> new NotFoundException("Book not found. It may not be synchronized yet from Books service."));
        ...
        if (lendingEventsPublisher != null) {
            lendingEventsPublisher.sendLendingCreated(savedLending);
        }
    ...
    public Lending setReturned(final String lendingNumber, final SetLendingReturnedRequest resource, final long desiredVersion) {
        ...
        // Publish event to RabbitMQ
        if (lendingEventsPublisher != null) {
            lendingEventsPublisher.sendLendingReturned(savedLending, savedLending.getVersion());
        }
