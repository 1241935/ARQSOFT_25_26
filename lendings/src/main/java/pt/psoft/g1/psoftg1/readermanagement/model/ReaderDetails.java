...
public class ReaderDetails extends EntityWithPhoto {
    ...
    @Setter
    @ManyToMany
    private List<GenreSync> interestList;

    public ReaderDetails(int readerNumber, Reader reader, String birthDate, String phoneNumber, boolean gdpr, boolean marketing, boolean thirdParty, String photoURI, List<GenreSync> interestList) {
    ...
    public void applyPatch(final long currentVersion, final UpdateReaderRequest request, String photoURI, List<GenreSync> interestList) {
