...
public class ReaderServiceImpl implements ReaderService {
    ...
    public ReaderDetails create(CreateReaderRequest request, String photoURI) {
        ...
        List<GenreSync> interestList = this.getGenreListFromStringList(stringInterestList);
    ...
    private List<GenreSync> getGenreListFromStringList(List<String> interestList) {
        ...
        List<GenreSync> genreList = new ArrayList<>();
        for(String interest : interestList) {
            Optional<GenreSync> optGenre = genreSyncRepository.findByGenre(interest);
            if(optGenre.isEmpty()) {
                throw new NotFoundException("Could not find genre with name " + interest + ". It may not be synchronized yet from Books service.");
            }
