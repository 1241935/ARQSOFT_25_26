...
/**
 * Base mapper interface for the Lendings microservice.
 * Provides common mapping utilities for links and value conversions.
 */
public abstract class MapperInterface {
    ...
    protected Map<String, String> mapBookLink(BookSync book){
