...
public class SqlLending {
     ...
     */
    @Getter
    private SqlLendingNumber lendingNumber;
     ...
     * business specified number of days a reader can take to return the book ({@link SqlLending#MAX_DAYS_PER_LENDING}).
     *
    ...
    public SqlLending(SqlBook book, SqlReaderDetails readerDetails, int seq, int lendingDuration, int fineValuePerDayInCents){
        ...
        this.lendingNumber = new SqlLendingNumber(seq);
    ...
    public static SqlLending newBootstrappingLending(SqlBook book,
        ...
        SqlLending lending = new SqlLending();
        ...
        lending.lendingNumber = new SqlLendingNumber(year, seq);
